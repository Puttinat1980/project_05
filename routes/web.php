...
Route::post('/admin/calender/add', [App\Http\Controllers\CalenderaddController::class, 'index'])->name('adminpage.admincalender.add');
...
Route::post('/admin/employee/add', [App\Http\Controllers\EmployeeaddController::class, 'add'])->name('adminpage.adminemployee.add');
...
Route::post('/admin/workings/add', [App\Http\Controllers\WorkingsaddController::class, 'add'])->name('adminpage.adminworkings.add');
...
Route::post('/admin/history/add', [App\Http\Controllers\HistoryaddController::class, 'add'])->name('adminpage.adminhistory.add');
...
Route::post('/admin/process/add', [App\Http\Controllers\ProcessaddController::class, 'add'])->name('adminpage.adminprocess.add');
